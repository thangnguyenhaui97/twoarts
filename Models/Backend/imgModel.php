<?php
	/*
	* File name: Models/Backend/imgModel.php
	* Loai file: file model trong mo hinh MVC
	*/
	trait imgModel{
		//ham lay danh sach cac ban ghi
		public function fetchAll($from, $recordPerPage){//ham fetchAll cua class imgModel
			//lay doi tuong connection de thao tac csdl
			$db = connection::getInstance();
			//chuan bi truy van
			$query = $db->prepare("select * from tbl_img_footer order by id desc limit $from, $recordPerPage");
		...
		public function total(){
			...
			$query_total = $db->prepare("select id from tbl_img_footer");
			$query_total->execute();
		...
		public function fetchOne(){
			...
			$query = $db->prepare("select * from tbl_img_footer where id=:id");
			//lay theo kieu object
			$query->setFetchMode(PDO::FETCH_OBJ);
			//thuc thi truy van
		...
		public function executeEdit(){
			...
			$query = $db->prepare("update tbl_img_footer set name=:name where id=:id");
		...
		public function executeAdd(){
			...
			$query = $db->prepare("insert into tbl_img set name=:name");
		...
		public function executeDelete(){
			...
			$db = connection::getInstance(); //Core/connection.php
			//update email, fullname tuong ung voi ban ghi co id truyen vao
			$query = $db->prepare("delete from tbl_img_footer where id=:id");
