	...
	*/
	trait userModel{
		...
		public function executeEdit(){
			...
			$query = $db->prepare("update tbl_user set fullname=:fullname, email=:email, address=:address, phone=:phone where id=:id");
			$query->execute(array("fullname"=>$fullname,"email"=>$email, "address"=>$address, "phone"=>$phone,"id"=>$id));
